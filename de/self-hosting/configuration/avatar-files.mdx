...
<CardGroup cols={2}>
  ...
  <Card title="Von Avaluma beziehen" icon="key">
    Du erhältst `.hvia`-Dateien von [avaluma.ai](https://avaluma.ai) zusammen mit deinem Lizenzschlüssel. Weitere Avatare folgen laufend — zusätzliche oder individuelle Avatar-Dateien forderst du unter [hello@avaluma.ai](mailto:hello@avaluma.ai) an.
  </Card>
</CardGroup>
