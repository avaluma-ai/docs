...
- Empfängt Audio vom LiveKit-Agent über das Plugin `livekit-plugins-avaluma`
...
- **`AvatarSession`** — das Plugin `livekit-plugins-avaluma` leitet das TTS-Audio an den Avatar-Server weiter, der den Avatar animiert und das Video zurück in den Raum streamt
