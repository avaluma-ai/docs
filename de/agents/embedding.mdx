...
Wie im Kiosk optimiert der eingebettete Agent die Wiedergabe automatisch: Auf iPad/iPhone läuft der Ton in voller Lautstärke, auf Android schaltet er auf den lauten Systemlautsprecher. Oben rechts im iframe sitzen zwei Symbole: ein **Lautsprecher-Symbol** für die Lautstärke des Agenten (unabhängig von der Gerätelautstärke, die Einstellung wird gemerkt) und ein **Zahnrad-Symbol** für Audioverarbeitung und Ausgabe-Gerät. Die Details stehen im Kiosk-Abschnitt [Ton & Lautstärke](/de/agents/kiosk#ton--lautstärke) — dort auch, was passiert, [wenn das Mikrofon ausfällt](/de/agents/kiosk#wenn-das-mikrofon-ausfällt), samt der bekannten Einschränkung bei Bluetooth-Headsets in Firefox auf Android.
