...
<CardGroup cols={2}>
  ...
  <Card title="Obtain from Avaluma" icon="key">
    You receive `.hvia` files from [avaluma.ai](https://avaluma.ai) together with your license key. More avatars are added continuously — request additional or custom avatar files at [hello@avaluma.ai](mailto:hello@avaluma.ai).
  </Card>
</CardGroup>
